...
/**
 * HashMap to txtuml is a extension of the class java.util.HashMap. But
 * specifically was create to use with < String,String >.
 * <p>
 ...
 * buckets) plus its size (the number of key-value mappings). Thus, it's very
...
public interface HashMap extends ExternalClass {
	 ...
	 *
	 */
	public java.util.HashMap<String, String> put(String key, String value);

	/**
	 * Removes the mapping for the specified key from this map if present.
	 *
	 */
	public java.util.HashMap<String, String> remove(String key);
